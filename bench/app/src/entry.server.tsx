/**
 * Bench app 服务端 entry —— 最小化的 defineSiteHooks 配置
 *
 ...
 * 覆盖, 不需要在 bench app 里再做集成测试 (那只会把响应弄成带 Set-Cookie,
...
export default defineSiteHooks({
  ...
  seo: {
    '/': { title: 'Bench Home', description: 'bench root' },
    '/about': { title: 'Bench About', description: 'bench about' },
  },
});
