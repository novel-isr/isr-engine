...
| 单元测试覆盖 | 数千用例 | ⚠️ | ✅ | 59 文件 / 718 tests / ~58% |
...
- 718 tests / ~58% 行覆盖；CI 任何分支 push 都跑 lint+typecheck+test
...
- 浏览器侧没有持续跑的 e2e（718 测试主要是 Node 侧单测），靠人工
